...
- `app.js` — **v263** (v263 — **the radar has a weekly twin, and says which one you
...
- `style.css` — **v231** (v231: `.sr-period` — the Sector Radar's period tag. Neutral
